...
public class ListaPersonas implements Serializable {
	...
	/**
	 * Agrega una persona al ArrayList
	 * @param persona
	 * @return agrega persona al ArrayList y modifica el valor del campo modificado.
	 * @throws EmpleadoYaExisteException 
	 * @throws DniInvalidoException 
	 */
	public boolean agregarPersona(Persona persona, String dni) throws EmpleadoYaExisteException, DniInvalidoException{
		if(get(dni))
	 ...
	 * @throws DniInvalidoException 
	 */
	public boolean eliminar(Persona persona) throws PersonaNoExisteException, DniInvalidoException {
			return listaPersonas.remove(persona) && Gestion.setModificado(true);
	}
	

	/**
	 * Busca el empleado en el ArrayList a través del DNI, se utiliza para mostrar un empleado antes de eliminarlo y buscarlo por DNI.
	 * @param dni
	 ...
	 * @throws PersonaNoExisteException
	 */
	public Persona getP(String dni) throws DniInvalidoException, PersonaNoExisteException {
	...
	/**
	 * Busca un empleado a través del DNI. Se utiliza para no añadir un empleado con el mismo DNI.
	 * @param dni
	 * @return 
	 * @throws DniInvalidoException
	 */
	...
	/**
	 * Comprueba si hay más elementos antes o después del ArrayList, se utiliza para mostrar empleados.
	 * @param index
	 * @return empleado almacenado en el ArrayList
	 */

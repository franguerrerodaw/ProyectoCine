...
public class Persona implements Serializable{
	...
	/**
	 * Sueldo para cada persona creada.
	 */
	 ...
	 * 
	 */
	private static final Pattern patternNombre = Pattern.compile("(?i)^[a-záéíóúñ ]+$");
	
	/**
	 * El DNI solo puede contener 8 dígitos, un guion y una letra.
	 */
	private static final Pattern patternDni = Pattern.compile("^(\\d{8})[-]([A-Z]{1})$");
	
	/**
	 * El email solo puede contener una palabra que comience por una letra seguido de más letras o números, un arroba, letras, un punto y más letras.
	 */
	private static final Pattern patternEmail = Pattern.compile("^([a-z]{1})[a-z0-9]+[@][a-z]+[.][a-z]+$");
	 ...
	 */
	public Persona(String nombreYApellidos, int precioHora, String dni, String direccion, Date fechaNacimiento, String telefono, String email, Date alta, int horasSemanales) throws NombreInvalidoException, DniInvalidoException, EmailInvalidoException{
	 ...
	 * @param nombre y apellidos de la persona
	 * @throws NombreInvalidoException 
	 */
	private void setNombreYApellidos(String nombreYApellidos) throws NombreInvalidoException {
		if (nombreValido(nombreYApellidos))
			this.nombreYApellidos = nombreYApellidos;
		else
			throw new NombreInvalidoException("El nombre introducido es incorrecto.");
	}
	/**
	...
	/**
	 * Comprueba que el DNI sea en minúscula, que contenga solo letras o números, que tenga un símbolo de arroba y un punto.
	 * @param dni2
	...
	public void setEmail(String email) throws EmailInvalidoException {
		if (emailValido(email))
			...
			throw new EmailInvalidoException("El email introducido es incorrecto.");
	}
